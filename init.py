...
def init():
    ...
    locale_syncer = S3(config.RESOURCE_BUCKET, config.SYSTEM_LOCALE_PATH, region_name=config.AWS_REGION_NAME, key=config.AWS_ACCESS_KEY_ID, secret=config.AWS_SECRET_ACCESS_KEY)
