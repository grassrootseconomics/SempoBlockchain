...
@pytest.mark.parametrize("transfer_amount, target_balance, credit_transfer_uuid_selector_func, "
    ...
    (None, None, lambda t: None, lambda u: None, lambda u: None, lambda u: None, None, 'view-public', None, 403),
    (None, None, lambda t: None, lambda u: None, lambda u: None, lambda u: None, None, 'view-private', None, 403),
    (None, None, lambda t: t.uuid, lambda u: None, lambda u: None, lambda u: None, None, 'subadmin', 'PENDING', 201),
    ...
    (10, None, lambda t: None, lambda u: None, lambda u: u.id, lambda u: u.id, 'PAYMENT', 'admin', 'COMPLETE', 201),
    (
    ...
    (10, None, lambda t: None, lambda u: u.id, lambda u: None, lambda u: None, 'BALANCE', 'admin', 'COMPLETE', 201),  # returns 400 in bulk
    ...
    (10, None, lambda t: None, lambda u: None, lambda u: u.id, lambda u: None, 'RECLAMATION', 'admin', 'COMPLETE', 201),
